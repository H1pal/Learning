...
import { TodoDispatchContext } from "./Body";

const TodoItem = ( { id, content, createDate, isDone} ) => {
  // 1. Context에서 onUpdate 및 onDelete 함수 추출
  ...
  return(
    <div id="todoitem_container">
      <div className="checkbox_col">
        ...
        <input type="checkbox" checked={isDone} name="input-items" id="input-items" onChange={ () => onUpdate(id) }/>
      </div>
